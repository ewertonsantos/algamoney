...
public class CategoriaResource {
		...
		@PostMapping
		public ResponseEntity<categoria> criar(@Valid @RequestBody categoria categ, HttpServletResponse response) {
			
			categoria categoriaSalva = categoriaRepository.save(categ);
